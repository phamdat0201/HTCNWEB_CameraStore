...
function addThongKe() {
    var dataChart = {
        type: 'bar',
        data: {
            labels: ["Canon", "Sony", "Samsung", "Nikon", "Panasonic", "Kodak"],
            datasets: [{
...
function layThongTinSanPhamTuTable(id) {
    ...
    var camBien = tr[11].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var manHinh = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var layNet = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var quayPhim = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var iso = tr[15].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var tocDoChup = tr[16].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var boNho = tr[17].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var kichThuoc = tr[18].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var trongLuong = tr[19].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Samsung", "Nikon", "Panasonic", "Canon", "Sony", "Kodak", "Fujifilm", "Leica", "Olympus", "Pentax"];
    ...
    s += `
        ...
        <tr>
            <td>Cảm biến:</td>
            <td><input type="text" value="`+sp.detail.camBien+`"></td>
        </tr>
        <tr>
            <td>Màn hình:</td>
        ...
        <tr>
            <td>Lấy nét:</td>
            <td><input type="text" value="`+sp.detail.layNet+`"></td>
        </tr>
        <tr>
            <td>Quay phim:</td>
            <td><input type="text" value="`+sp.detail.quayPhim+`"></td>
        </tr>
        <tr>
            <td>ISO:</td>
            <td><input type="text" value="`+sp.detail.iso+`"></td>
        </tr>
        <tr>
            <td>Tốc độ chụp:</td>
            <td><input type="text" value="`+sp.detail.tocDoChup+`"></td>
        </tr>
        <tr>
            <td>Bộ nhớ:</td>
            <td><input type="text" value="`+sp.detail.boNho+`"></td>
        </tr>
        <tr>
            <td>Kích thước:</td>
            <td><input type="text" value="`+sp.detail.kichThuoc+`"></td>
        </tr>
        <tr>
            <td>Trọng lượng:</td>
            <td><input type="text" value="`+sp.detail.trongLuong+`"></td>
        </tr>
        <tr>
